...
function App() {
  const [activeTab, setActiveTab] = useState<'main' | 'clipper' | 'settings' | 'history'>('main');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-3 border border-slate-700/50 hover:border-purple-500/50 hover:bg-slate-800/70 transition-all text-center group"
              >
                <svg className="w-5 h-5 text-slate-400 group-hover:text-purple-400 mx-auto mb-1 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
                <span className="text-xs text-slate-400 group-hover:text-white transition-colors">Демо</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-xs text-slate-400 group-hover:text-white transition-colors">История</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-xs text-slate-400 group-hover:text-white transition-colors">Настройки</span>
              </button>
            </div>
          </div>
        )}
        ...
        <p className="text-center text-xs text-slate-500 mt-4">
          Web Clipper Extension v1.1 • Powered by Defuddle
        </p>
      </div>
    </div>
  );
